...
namespace ShoppingPlatform.API.Data.Migrations
{
    ...
    [Migration("20210521170023_AddedRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingPlatform.API.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingPlatform.API.Entities.Transaction", b =>
                {
                    ...
                    b.Property<bool>("IsVisibleByBuyer")
                        .HasColumnType("bit");

                    b.Property<bool>("IsVisibleBySeller")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ShoppingPlatform.API.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("ShoppingPlatform.API.Entities.UserRole", b =>
                {
                    b.HasOne("ShoppingPlatform.API.Entities.Role", "Role")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShoppingPlatform.API.Entities.User", "User")
                        .WithMany("Roles")
